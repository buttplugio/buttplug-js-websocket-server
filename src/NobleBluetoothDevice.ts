...
export class NobleBluetoothDevice extends EventEmitter implements IBluetoothDeviceImpl {

  public static async CreateDevice(aDeviceInfo: BluetoothDeviceInfo,
                                   aDevice: noble.Peripheral):
  Promise<ButtplugBluetoothDevice> {
    const deviceImpl = new NobleBluetoothDevice(aDeviceInfo, aDevice);
